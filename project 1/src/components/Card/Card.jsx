...
export default function Card(obj) {
    ...
    const author = obj.obj.author ;
    const img = obj.obj.urlToImage ;
    const desc = obj.obj.description ;
    const url = obj.obj.url ;
    
return (

<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-5 w-25%">
    
    <img className="rounded-t-lg" src ={img} alt="" />
    
    <div className="p-5">
        
    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">By : {author}</p>
